    ...
    <section class="single-truck-page" data-component="single-truck">
        ...
        <div class="hidden max-w-screen-xl mx-auto wishlist-title lg:px-gutter sticky top-nav z-10 bg-white">
            <div class="px-gutter lg:px-4 flex justify-between items-start border-b border-gray-200 py-2">
                ...
                <button class="add-to-wishlist" data-truck="<?php echo ll_safe_encode( $truck ); ?>" title="Add <?php echo $truck->name; ?> to Wishlist">
                    <svg class="icon icon-heart text-2xl text-gray-200 pointer-events-none">
        ...
        </div> <!-- /.single-inventory-back -->

        <div class="col w-full single-inventory-item mx-0 px-0">
            <div class="single-info-pane block lg:hidden p-8 pb-0 on-template-truck-one">
                <h2 style="font-size: 2rem;" class="border-b border-solid border-gray-300 text-xxl py-4 single-info-pane-headline">
                    <?php echo $truck->YEAR . ' ' . $truck->MANUFACTURER . ' ' . $truck->MODEL; ?>
                </h2>
                <div class="single-price-miles overflow-auto mb-4">
                    ...
                    <?php else : ?>
                        <h3 class="spm-red" style="font-weight: normal;">
                            <span style="text-decoration: line-through;display: inline-block;margin-right: 1rem;font-weight: bold;">
                                $<?php echo number_format($truck->OLDPRICE); ?>
                            </span>
                            Incentives available.
                        </h3>
                        <span class="spm-red" style="font-size: 1.25rem;margin-bottom: 1rem;display: block;">
                    ...
                    <?php if($truck->MODEL != 'Trailer') : ?>
                        <h3 class="spm-gray">
                            <?php echo number_format($truck->MILEAGE); ?> Miles
                        </h3>
                        <h3 class="spm-gray" style="font-size: 1rem;opacity: 0.7;">
                            ECM Mileage: <?php echo number_format($truck->ECMMILEAGE); ?>
                        </h3>
                    <?php endif; ?>

                </div> <!-- /.single-price-miles -->

                <div class="single-vehicle-list-details flex flex-wrap">
                    <div class="flex flex-initial w-full single-vehicle-engine-make-model">
                        <svg class="icon icon-semi-truck mr-2 text-xl svg-align">
                            <use xlink:href="#icon-semi-truck"></use>
                        </svg>
                        <p>
                            <?php echo $truck->ENGINEMAKE; ?> <?php echo $truck->ENGINEMODEL; ?>
                        </p>
                    </div> <!-- /.single-vehicle-engine-make-model -->
                    <div class="flex flex-initial w-full single-vehicle-horsepower">
                        <svg class="icon icon-speedometer mr-2 text-xl svg-align">
                            <use xlink:href="#icon-speedometer"></use>
                        </svg>
                        <p>
                            HP: <?php echo $truck->HORSEPOWER; ?>
                        </p>
                    </div> <!-- /.single-vehicle-horsepower -->
                    <div class="flex flex-initial w-full single-vehicle-city-state">
                        <svg class="icon icon-pin mr-2 text-xl svg-align">
                        ...
                        <p>
                            <?php echo $singleLocation; ?>, <?php echo $singleState; ?>
                        </p>
                    </div> <!-- /.single-vehicle-city-state -->

                    <div class="flex flex-initial w-full single-vehicle-stock-number">
                        <p class="mt-2">Stock # <?php echo $truck->STOCKNUM; ?></p>
                    </div> <!-- /.single-vehicle-stock-number -->
                </div> <!-- /.single-vehicle-list-details -->
            </div> <!-- /.single-info-pane -->

            <div class="block lg:hidden single-vehicle-all-images-wrapper">
                ...
                <?php if ( $truck->images->count() > 1 ) : ?>
                    <div class="p-8 main-image-wrapper">
                        ...
                        <?php foreach( $truck->images as $key => $image ) : ?>
                            ...
                            <div class="image-wrapper relative aspect-4/3 overflow-hidden">
                                ...
                                <a href="<?php echo $image; ?>" target="_blank" style="position: absolute;bottom: 0;font-size: .75rem;font-weight: bold;bottom: 0;right: 5px;color: rgba(255,255,255,0.5);">
                                    OPEN IN WINDOW
                                </a>
                            </div> <!-- /.image-wrapper -->
                    ...
                    <div class="video-wrapper">
                        ...
                        <?php if ( $truck->HASVIDEO == 'Y' ) : ?>
                            ...
                            <div class="mobile-is-a">
                                ...
                                </div> <!-- /.mobile-is-a-video-placeholder -->
                            </div> <!-- /.mobile-is-a -->
                    ...
                    <div class="single-truck-desription px-6">
                        ...
                        <h2 class="my-4 mt-8">
                            <?php echo $whatIam; ?> Description
                        </h2>
                        <h3>
                            <?php echo $truck->HEADLINE; ?>
                        </h3>
                        <p>
                            <?php echo $truck->COMMENTS; ?>
                        </p>
                    </div> <!-- /.single-truck-desription -->
            ...
            </div> <!-- /.single-vehicle-all-images-wrapper -->
            <div class="flex flex-wrap">
                ...
                </div> <!-- /.single-inventory-left -->
                <div class="flex-initial w-full lg:w-1/3 single-inventory-right p-4 lg:p-16">
                    <div class="single-get-started">
                        <div class="single-info-pane hidden lg:block on-template-truck">
                            <!-- start info pane -->
                            <h2 class="single-info-pane-headline">
                                <?php echo $truck->YEAR . ' ' . $truck->MANUFACTURER . ' ' . $truck->MODEL; ?>
                            </h2>
                            <div class="single-price-miles overflow-auto mb-4">
                            ...
                            <div class="single-vehicle-list-details flex flex-wrap">
                                ...
                                <div class="flex flex-initial w-full">
                                    ...
                                    <?php
                                        ...
                                        if(c$singleLocation == 'St. Louis'c){
                                            $singleState = 'MO';
                                        }
                                    ?>
                                ...
                                <div class="flex flex-initial w-full">
                                    <p class="mt-2">
                                        Stock # <?php echo $truck->STOCKNUM; ?>
                                    </p>
                                </div>
                            </div>
                            <div class="single-truck-desription">
                                <h2 class="my-4 mt-8"><?php echo $whatIam; ?>
                                    Description
                                </h2>
                                <h3>
                                    <?php echo $truck->HEADLINE; ?>
                        ...
                        <div class="single-drop-down-wrapper flex flex-wrap py-8">
                            <div class="flex-initial w-full single-each-drop-down sv-featuresandspecs">
                                <div id="features-and-specs-head" class="single-each-drop-down-top w-full relative py-4 flex justify-between items-center border-t border-gray-300">
                                    ...
                                    <svg id="features-chevron-down" class="icon icon-chevron-down mr-2 text-xl text-brand-primary svg-align">
                                        <use xlink:href="#icon-chevron-down"></use>
                                    </svg>
                                    <svg id="features-chevron-up" class="hidden icon icon-chevron-up mr-2 text-xl text-brand-primary svg-align">
                                    ...
                                    <?php if ( $truck->MODEL != 'Trailer' ) : ?>
                                        ...
                                        <div class="fs-section section-transmmission w-full">
                                            ...
                                            <div class="<?php echo $truck->TRANSNAME ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRANSNAME; ?>
                                                </p>
                                            </div>
                                        </div> <!-- /.section-transmmission -->
                                        <div class="fs-section section-wheels-and-tires w-full">
                                            ...
                                            <div class="<?php echo $truck->TIRESIZE ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TIRESIZE; ?>
                                                </p>
                                            </div>
                                        </div> <!-- /.section-wheels-and-tires -->
                                    ...
                                    <?php else : ?>
                                        ...
                                        <div class="fs-section section-trailer w-full">
                                            ...
                                            <div class="<?php echo $truck->TRAILERREEFERMAKE ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRAILERREEFERMAKE; ?>
                                                </p>
                                            </div>
                                            <div class="<?php echo $truck->TRAILERREEFERMODEL ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRAILERREEFERMODEL; ?>
                                                </p>
                                            </div>
                                            <div class="<?php echo $truck->TRAILERREEFERHOURS ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRAILERREEFERHOURS; ?>
                                                </p>
                                            </div>
                                            <div class="<?php echo $truck->TRAILERREEFERYEAR ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRAILERREEFERYEAR; ?>
                                                </p>
                                            </div>
                                            <div class="<?php echo $truck->TRAILERTIRESIZE ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRAILERTIRESIZE; ?>
                                                </p>
                                            </div>
                                            <div class="<?php echo $truck->TRAILERSIDESKIRTS ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRAILERSIDESKIRTS; ?>
                                                </p>
                                            </div>
                                            <div class="<?php echo $truck->TRAILERTIEDOWNS ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRAILERTIEDOWNS; ?>
                                                </p>
                                            </div>
                                            <div class="<?php echo $truck->TRAILERCOMPOSITION ? 'flex' : 'hidden' ?> w-full justify-between align-center fs-data-item">
                                                ...
                                                <p class="fs-data">
                                                    <?php echo $truck->TRAILERCOMPOSITION; ?>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                </div> <!-- /.single-each-drop-down-bottom -->
                            </div>
                            <div class="flex-initial w-full single-each-drop-down sv-warranties">
                                <div id="warranties-head" class="single-each-drop-down-top w-full relative py-4 flex justify-between items-center border-t border-gray-300">
                                    ...
                                    <svg id="warranties-chevron-down" class="icon icon-chevron-down mr-2 text-xl text-brand-primary svg-align">
                                        <use xlink:href="#icon-chevron-down"></use>
                                    </svg>
                                    <svg id="warranties-chevron-up" class="hidden icon icon-chevron-up mr-2 text-xl text-brand-primary svg-align">
                                        <use xlink:href="#icon-chevron-up"></use>
                                    </svg>
                                </div>
                                <div id="warranties-content" class="hidden single-each-drop-down-bottom p-4">
                                    <div class="warranties-wrapper">
                                        <div class="warranties-header flex justify-start align-center">
                                            <svg class="icon icon-checkmark-filled mr-2 text-xl text-brand-primary svg-align">
                                                <use xlink:href="#icon-checkmark-filled"></use>
                                            </svg>
                                            <h3>
                                                Extended Warranties
                                            </h3>
                                        ...
                                        <div class="warranties-content">
                                            <ul>
                                                <li>
                                                    Protection for up to 4 years / 400,000 miles
                                                </li>
                                                <li>
                                    ...
                                    <div class="warranties-wrapper">
                                        ...
                                        <div class="warranties-content">
                                            <ul>
                                                <li>
                                                    Coverage on 42 vital system components
                                                </li>
                                                <li>
                                                    Both medium and heavy duty diesel engines
                                                </li>
                                                <li>
                                                    Plans available from 6 to 48 months
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="warranties-wrapper">
                                        <div class="warranties-header flex justify-start align-center">
                                            ...
                                            <h3>
                                                ConfidencePLUS<em>&trade;</em> Comprehensive Coverage
                                            </h3>
                                        </div>
                                        <div class="warranties-content">
                                            <ul>
                                                <li>
                                                    90 day / 25,000 mile coverage
                                                </li>
                                                <li>
                                                    Standard on virtually every late-model truck we sell at no extra cost to you
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    </div> <!-- /.warranties-wrapper -->
                                </div> <!-- /.single-each-drop-down-bottom -->
                            </div> <!-- /.single-each-drop-down -->
                        ...
                        <div class="single-get-started-buttons flex flex-wrap">
                            ...
                            <div class="flex-initial w-full single-get-started-buttons-each my-1">
                                <button onclick="window.location.href='/down-payment-estimator/?price=<?php echo $truck->PRICE; ?>&stock=<?php echo $truck->STOCKNUM; ?>&mileage=<?php echo $truck->MILEAGE; ?>'" type="button" name="button" class="w-full p-4 text-left rounded single-get-started-button">
                                    <svg class="icon icon-estimate mr-2 text-xl text-brand-primary svg-align">
                            ...
                            <div class="flex-initial w-full single-get-started-buttons-each my-1">
                                <button onclick="window.location.href='/pre-qualify/?price=<?php echo $truck->PRICE; ?>&stock=<?php echo $truck->STOCKNUM; ?>&mileage=<?php echo $truck->MILEAGE; ?>'" type="button" name="button" class="w-full p-4 text-left rounded single-get-started-button">
                                    <svg class="icon icon-guarantee mr-2 text-xl text-brand-primary svg-align">
                            ...
                            <div class="flex-initial w-full single-get-started-buttons-each my-1">
                                <button onclick="window.location.href='/apply-for-credit'" type="button" name="button" class="w-full p-4 text-left rounded single-get-started-button">
                                    <svg class="icon icon-waiver mr-2 text-xl text-brand-primary svg-align">
                                        <use xlink:href="#icon-waiver"></use>
                                    </svg>
                                    Credit Application
                                </button>
                            </div>
                            <div class="flex-initial w-full single-get-started-buttons-each my-1">
                                <button onclick="window.location.href='/truck-inquiry/?info_1=<?php echo $truck->YEAR; ?>&info_2=<?php echo $truck->MANUFACTURER; ?>&info_3=<?php echo $truck->MODEL; ?>&info_4=<?php echo $truck->STOCKNUM; ?>&price=<?php echo $truck->PRICE; ?>&mileage=<?php echo $truck->MILEAGE; ?>'" type="button" name="button" class="w-full p-4 text-left rounded single-get-started-button">
                                    <svg class="icon icon-mail mr-2 text-xl text-brand-primary svg-align">
                        ...
                        <div class="single-summary flex flex-wrap bg-gray-100 p-4 hidden">
                            ...
                            <div class="single-estimated-monthly flex-initial w-full">
                                ...
                                <p>
                                    Save time, apply in a few simple steps!
                                </p>
                            </div>
                        </div> <!-- /.single-summary -->
