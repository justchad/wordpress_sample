<?php
    ...
    $card = ( object ) [
        'href'      => null, //$truck->PERMALINK
        'origin'    => $truck->CONTEXT->origin,
        'name'      => null, //$truck->POST_DATA->post_title
        ...
        'location'  => ( object ) [
            'id'                => $truck->BRANCHID, // $truck->CONTEXT->current_location_id
            'city'              => $truck->LOCATION,
            'city_FORMAT'       => str_replace( ' ', '-', $truck->LOCATION ), // str_replace( ' ', '-', $truck->CONTEXT->address->city )
            'state'             => $truck->STATE, // $truck->CONTEXT->address->state
            'zip'               => null, // $truck->CONTEXT->address->zip
        ],
        'truck'     => ( object ) [
        ...
        'promotion' => null //( $truck->CONTEXT->promotion->title ) ? $truck->CONTEXT->promotion : null
    ];
...
?>
    ...
    <a
        ...
        class="SEARCH-TRUCK-CARD LOCATION-ID-<?php echo $card->location->id ?> LOCATION-CITY-<?php echo $card->location->city_FORMAT ?> LOCATION-STATE-<?php echo $card->location->state ?> relative block overflow-hidden truck-card bg-gray-100"
